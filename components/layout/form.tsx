...
import { Create } from "@/utils/teams/api"
...
const form = ({ table, method, data }: {
    ...
    const inputType = (field: any) => {
        ...
        switch (field.type) {
            ...
            case 3:
                ...
                break;
            case 4:
                return <ImageFile id={field.id} method={OnChange} disabled={view} value={avatar} />
                break;
        }
    }
    ...
    return (
        <div className='m-auto w-6/12 mb-10'>
            <Header Title={data.instructions} submit={Submit} method={method} />
